...
public class Populator implements CommandLineRunner {
    ...
    public void run(String...args) throws Exception {
        ...
        Song narutoSong = new Song(artist1, narutoAlbum, "R★O★C★K★S", "https://www.youtube.com/watch?v=4t__wczfpRI", "1:44");
        Song narutoSong2= new Song(artist1, narutoAlbum, "Haruka Kanata", "https://www.youtube.com/watch?v=nJ6A6GC_ki4", "1:40");
        Song narutoSong3= new Song(artist1, narutoAlbum, "Turning Saddness Into Kindness", "https://www.youtube.com/watch?v=9TOWvpAhu4g", "4:06");
        Song narutoSong4= new Song(artist1, narutoAlbum, "GO!!!", "https://www.youtube.com/watch?v=kV5UZvsvjcM", "3:56");
        Song cowboySong= new Song(artist2, cowboyAlbum, "Tank!","https://www.youtube.com/watch?v=n2rVnRwW0h8", "3:31");
        Song cowboySong2= new Song(artist2, cowboyAlbum, "Rush", "https://www.youtube.com/watch?v=l8wWa3O9cUo", "3:34");
        Song cowboySong3= new Song(artist2, cowboyAlbum, "Spokey Dokey", "https://www.youtube.com/watch?v=MduJjbcLSqE", "3:34");
        Song cowboySong4= new Song(artist2, cowboyAlbum, "Bad Dog No Biscuits","https://www.youtube.com/watch?v=EuAzPR0ACVw", "3:34");
        Song darlingSong= new Song(artist3, darlingAlbum,"Kiss of Death", "https://www.youtube.com/watch?v=mzJqxT1UGho", "4:10");
        Song darlingSong2 = new Song(artist3, darlingAlbum, "Beautiful World", "https://www.youtube.com/watch?v=QTCgYNzM7k4","4:19");
        Song darlingSong3= new Song(artist3, darlingAlbum,"Manatsu no Setsuna", "https://www.youtube.com/watch?v=1wggz0-xOsw", "3:42");
        Song darlingSong4= new Song(artist3, darlingAlbum,"Torikago", "https://www.youtube.com/watch?v=VD_JhspDBIg", "3:39");
        Song deathnoteSong= new Song(artist4, deathnoteAlbum,"The WORLD", "https://www.youtube.com/watch?v=btD61Bq0XJo", "3:37");
        Song deathnoteSong2= new Song(artist4, deathnoteAlbum,"Incident(Jiken)", "https://www.youtube.com/watch?v=iYJbUSWRWeU", "3:11");
        Song deathnoteSong3= new Song(artist4, deathnoteAlbum,"Lights Theme", "https://www.youtube.com/watch?v=E3LeZNlI0Xg", "3:15");
        Song deathnoteSong4= new Song(artist4, deathnoteAlbum,"L's Theme A,B, & C", "https://www.youtube.com/watch?v=tfvX4Py15Es", "8:08");
